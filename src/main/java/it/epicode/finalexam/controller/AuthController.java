...
import it.epicode.finalexam.exception.LoginFaultException;
import it.epicode.finalexam.model.LoginRequest;
import it.epicode.finalexam.model.Utente;
import it.epicode.finalexam.model.UtenteRequest;
import it.epicode.finalexam.security.JwtTools;
import it.epicode.finalexam.service.UtenteService;
...
public class AuthController {
    ...
    public String login(@RequestBody @Validated LoginRequest loginRequest, BindingResult bindingResult){
        ...
        if(encoder.matches(loginRequest.getPassword(), utente.getPassword())){
            ...
            throw new LoginFaultException("Username e password errate");
        }
